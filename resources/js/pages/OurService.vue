                  ...
                  <div class="row">
                      ...
                      <div class="col-lg-6">
                          <div class="contact-content">
                              ...
                              <form @submit.prevent="sendEmail"  id="contact-form" class="contact-form-items">
                                  <div class="row g-4">
                                      <div class="col-lg-6 wow fadeInUp" data-wow-delay=".3s">
                                          <div class="form-clt">
                                              <span>Your name*</span>
                                              <input type="text" name="name" v-model="formData.name" id="name" placeholder="Rahat Uddin Azad">
                                          </div>
                                      </div>
                                      <div class="col-lg-6 wow fadeInUp" data-wow-delay=".5s">
                                          <div class="form-clt">
                                              <span>Your Email*</span>
                                              <input type="text" v-model="formData.email" required name="email" id="email" placeholder="info@example.com">
                                          </div>
                                      </div>
