                                ...
                                <div class="col-lg-8">
                                    <div class="hero-content">
                                        <h5 data-animation="slideInRight" data-duration="2s" data-delay=".3s">
                                            One Of The Best IT company in Bangladesh
                                        </h5>
                                        ...
                                        <p data-animation="slideInRight" data-duration="2s" data-delay=".9s">
                                            Our expert team crafts custom solutions that drive efficiency and unlock new opportunities for your business.
                                        </p>
                            ...
                            <div class="row g-4 align-items-center">
                                <div class="col-lg-8">
                                    <div class="hero-content">
                                        ...
                                        <p data-animation="slideInRight" data-duration="2s" data-delay=".9s">
                                            We deliver cutting-edge apps and web-based solutions that accelerate your growth in today’s digital world.
                                        </p>
                                        <div class="hero-button">
                                            <a
                                                href="/about"
...
export default defineComponent({
    components: {Testimonials, Marque, Projects, Achievements, WorkProcesses, Services, Brands}
})
</script>
